...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="colored"> -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="/admin/template/{{$template->id}}/update" method="POST">
                                        {{csrf_field()}}
                                        ...
                                        @include('admin.layout.error')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" id="slectTemplate" name="slectTemplate" value="">
                                        ...
                                        <input type="text" id="template_data" name="template_data" value="{{$template}}" hidden>
        ...
        <script src="/admin/js/template_edit.js"></script>
