                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="custom-accordion">
                                    ...
                                    <div class="card">
                                        <a href="#checkout-paymentinfo-collapse" class="collapsed text-dark" data-toggle="collapse">
                                            <div class="p-4">
                                ...
                                <div class="card checkout-order-summary">
                                    <div class="card-body">
                                        <div class="p-3 bg-light mb-4">
                                            <h5 class="font-size-16 mb-0">Order Summary <span class="float-right ml-2">#MN0124</span></h5>
                                        </div>
