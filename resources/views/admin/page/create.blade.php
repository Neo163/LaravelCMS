...
<div class="col-sm-12 blog-main">
    <form action="<?php echo url(''); ?>/admin/pages/list" method="POST">
        {{csrf_field()}}
        ...
        <div class="form-group">
            <label>内容</label>
            <textarea id="content" name="content" class="form-control" style="height:500px;"  placeholder="内容"></textarea>
        </div>
