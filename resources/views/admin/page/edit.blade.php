...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="colored"> -->
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">
                                        新增循环页 
                                        &nbsp;&nbsp; | &nbsp;&nbsp;
                                        <span type="button" id="hidePageContent" class="mb-0 btn btn-outline-primary waves-effect waves-light pageContentText" status="{{$bpage->content_show}}" page="{{$bpage->id}}">
                                            @if($bpage->content_show == 0)
                                            隐藏主体
                                            <script>
                                                $("#pageContentBox").hide()
                                                $("#pageContentBox").css('display','none');
                                            </script>
                                            @endif
                                            @if($bpage->content_show == 1)
                                            <script>
                                                $("#pageContentBox").css('display','none');
                                            </script>
                                            显示主体
                        ...
                        <!-- Post content Start -->
                        <form action="/admin/page/update/{{$bpage->id}}" method="POST">
                        {{csrf_field()}}
        ...
        <input type="text" id="b_page_id" name="b_page_id" value="{{$bpage->id}}" hidden>
        ...
        <script src="/admin/js/page_add_edit.js"></script>
        <script src="/admin/js/page_edit.js"></script>
