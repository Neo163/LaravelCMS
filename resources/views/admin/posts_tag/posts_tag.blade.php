    ...
    <!-- <body data-layout="horizontal" data-topbar="colored"> -->
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <button class="btn btn-success waves-effect waves-light add-posts-tag" data-toggle="modal" data-target="#addItem" id="addItemLeft1"><i class="mdi mdi-plus mr-2"></i> 新增循环页标签</button>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-inline float-md-right mb-3">
                                                    <div class="search-box ml-2">
                                                        <div class="position-relative">
                                                            ...
                                                            <span id="nestable-posts-tags">

                                                                <button type="button" class="btn btn-outline-success waves-effect waves-light posts-tags-expand-all" data-action="expand-all">扩展</button>

                                                                <button type="button" class="btn btn-outline-success waves-effect waves-light posts-tags-collapse-all" data-action="collapse-all">折合</button>
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <span id="nestable-posts-tag">
                                                                    <span class="dropdown-item pointer" data-action="expand-all">扩展媒体小类</span>
                                                                    <span class="dropdown-item pointer" data-action="collapse-all">折合媒体小类</span>
                                                                </span>
                                                                <span id="nestable-posts-type">
                                                                    <span class="dropdown-item pointer" data-action="expand-all-types">扩展媒体大类</span>
                                                                    <span class="dropdown-item pointer" data-action="collapse-all-teyps">折合媒体大类</span>
                                                                </span>
                                                            </div> -->
                                                        </div>
                                                    </div>
                ...
                <input type="hidden" id="b_posts_tag_id" value="{{$bPostType->id}}">
                <input type="hidden" id="b_posts_tag_title" value="{{$bPostType->title}}">
        ...
        <script src="/admin/js/posts_tag.js"></script>
